...
public class Api_MIXER_MixDemo_DemoEntity implements JsonSerializable {
...
ja-jp:多言語テスト
     ...
     */
    public static Api_MIXER_MixDemo_DemoEntity deserialize(String json) {
     ...
     */
    public static Api_MIXER_MixDemo_DemoEntity deserialize(JsonObject json) {
        if (json != null && !json.isJsonNull()) {
            Api_MIXER_MixDemo_DemoEntity result = new Api_MIXER_MixDemo_DemoEntity();
