 ...
 *
 */
public class Apitest_TestNone extends BaseRequest<Api_NumberResp> {
      
    /**
     * 当前请求的构造函数，以下参数为该请求的必填参数
     * @param intParam int param
     */
    public Apitest_TestNone(int intParam) {
        super("apitest.testNone", SecurityType.None);
