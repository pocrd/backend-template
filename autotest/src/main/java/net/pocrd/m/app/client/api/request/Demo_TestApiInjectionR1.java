...
public class Demo_TestApiInjectionR1 extends BaseRequest<Api_DEMO_ComplexTestEntity> {
    ...
    private static final String[] importParams = new String[] { "user.userIds-net.pocrd.define.LongArrayStringInjector$Data", "product.productIds-net.pocrd.define.LongArrayStringInjector$Data" };
