...
public class Demo_TestApiInjectionR8 extends BaseRequest<Api_DEMO_ComplexTestEntity> {
     ...
     * @param name 名称
     */
    public Demo_TestApiInjectionR8(String name) {
        super("demo.testApiInjectionR8", SecurityType.None);
     ...
     * 私有的默认构造函数，请勿使用
     */
    private Demo_TestApiInjectionR8() {
        super("demo.testApiInjectionR8", SecurityType.None);
    }
    
    /**
     * 当前请求的非必填参数
     * @param activityIds 以半角逗号分隔的活动页id列表
     */
    ...
    private static final String[] importParams = new String[] { "supplier.supplierIds", "cms.activityIds" };
    ...
    public static class DependencyBuilder extends AbstractDependencyBuilder {
        ...
        public DependencyBuilder depends(BaseRequest dependency) {
            addDependency(Demo_TestApiInjectionR8.importParams, dependency);
            return this;
        }

        public Demo_TestApiInjectionR8 build(String name) {
            Demo_TestApiInjectionR8 request = new Demo_TestApiInjectionR8(name);
