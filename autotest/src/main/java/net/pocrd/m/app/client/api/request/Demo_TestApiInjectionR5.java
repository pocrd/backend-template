...
public class Demo_TestApiInjectionR5 extends BaseRequest<Api_DEMO_ComplexTestEntity> {
    ...
    private static final String[] exportParams = new String[] { "rma.userIds-net.pocrd.entity.LongArrayStringInjector$Data", "rma.rmaIds-net.pocrd.entity.LongArrayStringInjector$Data" };
