...
public class Api_MIXER_MixDemo_SimpleTestEntity implements JsonSerializable {
     ...
     */
    public static Api_MIXER_MixDemo_SimpleTestEntity deserialize(String json) {
     ...
     */
    public static Api_MIXER_MixDemo_SimpleTestEntity deserialize(JsonObject json) {
        if (json != null && !json.isJsonNull()) {
            Api_MIXER_MixDemo_SimpleTestEntity result = new Api_MIXER_MixDemo_SimpleTestEntity();
