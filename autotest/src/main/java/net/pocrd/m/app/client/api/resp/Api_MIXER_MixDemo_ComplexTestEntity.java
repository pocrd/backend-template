...
public class Api_MIXER_MixDemo_ComplexTestEntity implements JsonSerializable {
     ...
     */
    public List<Api_MIXER_MixDemo_SimpleTestEntity> simpleTestEntityList;
    /**
     * simpleTestEntity
     */
    public Api_MIXER_MixDemo_SimpleTestEntity       simpleTestEntity;
     ...
     */
    public static Api_MIXER_MixDemo_ComplexTestEntity deserialize(String json) {
     ...
     */
    public static Api_MIXER_MixDemo_ComplexTestEntity deserialize(JsonObject json) {
        if (json != null && !json.isJsonNull()) {
            Api_MIXER_MixDemo_ComplexTestEntity result = new Api_MIXER_MixDemo_ComplexTestEntity();
            ...
            if (element != null && !element.isJsonNull()) {
                ...
                result.simpleTestEntityList = new ArrayList<Api_MIXER_MixDemo_SimpleTestEntity>(len);
                for (int i = 0; i < len; i++) {
                    JsonObject jo = simpleTestEntityListArray.get(i).getAsJsonObject();
                    if (jo != null && !jo.isJsonNull()) {
                        result.simpleTestEntityList.add(Api_MIXER_MixDemo_SimpleTestEntity.deserialize(jo));
                    }
                }
            }
            ...
            if (element != null && !element.isJsonNull()) {
                result.simpleTestEntity = Api_MIXER_MixDemo_SimpleTestEntity.deserialize(element.getAsJsonObject());
            }
            ...
            if (element != null && !element.isJsonNull()) {
                ...
                if (e != null && !e.isJsonNull()) {
                    if ("SimpleTestEntity".equals(result.dynamicEntity.typeName)) {
                        result.dynamicEntity.entity = Api_MIXER_MixDemo_SimpleTestEntity.deserialize(e.getAsJsonObject());
                    } else if ("DemoEntity".equals(result.dynamicEntity.typeName)) {
                        result.dynamicEntity.entity = Api_MIXER_MixDemo_DemoEntity.deserialize(e.getAsJsonObject());
                ...
                for (int i = 0; i < len; i++) {
                    ...
                    if (jo != null && !jo.isJsonNull()) {
                        ...
                        if ("SimpleTestEntity".equals(de.typeName)) {
                            de.entity = Api_MIXER_MixDemo_SimpleTestEntity.deserialize(e.getAsJsonObject());
    ...
    public JsonObject serialize() {
        ...
        if (this.simpleTestEntityList != null) {
            ...
            for (Api_MIXER_MixDemo_SimpleTestEntity value : this.simpleTestEntityList) {
                if (value != null) {
